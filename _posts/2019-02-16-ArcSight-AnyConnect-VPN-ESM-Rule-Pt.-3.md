...
![Session List](/images/VPN3SessionList1.PNG "VPN Session")
...
![Rule Session Start Action](/images/VPN3Rule1Action1.PNG "Rule Session Start Action")

![Rule Session Stop Action](/images/VPN3Rule2Action2.PNG "Rule Session Stop Action") 
...
![Query 1 General](/images/VPN3Query1_1.PNG "Query 1 General")

![Query 1 Fields](/images/VPN3Query1_2.PNG "Query 1 Fields")
...
![Trend 1 General](/images/VPN3Trend1_1.PNG "Trend 1 General")

![Trend 1 Parameters](/images/VPN3Trend1_2.PNG "Trend 1 Parameters")
...
![Query 2 General](/images/VPN3Query2_1.PNG "Query 2 General")

![Query 2 Fields](/images/VPN3Query2_2.PNG "Query 2 Fields")
...
![Query Viewer 1 General](/images/VPN3QueryView1_1.PNG "Query View 1 General")

![Query Viewer 1 Fields](/images/VPN3QueryView1_2.PNG "Query View 1 Fields")
...
![Query 3 General](/images/VPN3Query3_1.PNG "Query 3 General")

![Query 3 Fields](/images/VPN3Query3_2.PNG "Query 3 Fields")

![Query 3 Conditions](/images/VPN3Query3_3.PNG "Query 3 Conditions")
...
![Query 3 Variable 1](/images/VPN3Query3Variable1.PNG "Query 3 Variable 1")


_userNametoLower_ variable is a string **ToLower** function that works on the _User Name_ list field.

![Query 3 Variables](/images/VPN3Query3_4.PNG "Query 3 Variables")
...
![Query Viewer 2 General](/images/VPN3QueryView2_1.PNG "Query View 2 General")

![Query Viewer 2 Fields](/images/VPN3QueryView2_2.PNG "Query View 2 Fields")
...
![Filter 1 Conditions](/images/VPN3Filter1.PNG "Filter 1 Conditions")
...
![Query 4 General](/images/VPN3Query4_1.PNG "Query 4 General")

![Query 4 Fields](/images/VPN3Query4_2.PNG "Query 4 Fields")

![Query 4 Conditions](/images/VPN3Query4_3.PNG "Query 4 Conditions")
...
![Report 1 Table Fields](/images/VPN3Report1_1.PNG "Report 1 Table Fields")
...
![Filter 2 Conditions](/images/VPN3Filter2.PNG "Filter 2 Conditions")
...
![Active List](/images/VPN3ActiveList1.PNG "Active List")
...
![Rule Accessed Addresses Conditions](/images/VPN3Rule4Condition.PNG "Rule Accessed Addresses Conditions")
...
![Rule Accessed Addresses Action](/images/VPN3Rule4Action1.PNG "Rule Accessed Addresses Action")
...
![Query 5 General](/images/VPN3Query5_1.PNG "Query 5 General")

![Query 5 Fields](/images/VPN3Query5_2.PNG "Query 6 Fields")
...
![Query 6 General](/images/VPN3Query6_1.PNG "Query 6 General")

![Query 6 Fields](/images/VPN3Query6_2.PNG "Query 6 Fields")
...
![Report 2 Table Fields](/images/VPN3Report2_1.PNG "Report 2 Table Fields")
